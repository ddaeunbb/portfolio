      ...
      <motion.div initial="hidden" variants={fadePop} animate="visible">
        <SC.Container>
          ...
          <SC.IntroImg className="bg-[url(/portfolio/stackoverflow/stackoverflow.png)]">
            <SC.UrlWrap>
              <a
                href="https://github.com/ddaeunbb/seb44_pre_015"
                target="_blank">
                <SC.UrlBtn>
          ...
          <SC.Wrap>
            ...
            <SC.Paragraph>
              메인 프로젝트를 시작하기 전, '스택오버플로우' 사이트를
              클론코딩하는 팀프로젝트를 진행하였습니다. 앞으로 메인프로젝트에서
              팀으로 작업하면서 백엔드분들과 어떻게소통해야할지, 팀원으로 어떻게
              기여해야할지 고민할 수 있는 뜻깊은 과정이었습니다.
            </SC.Paragraph>
          </SC.Wrap>
          ...
          <SC.Wrap>
            ...
            <SC.List>
              <li>Term: 2023.06.09 - 2023.06.27</li>
            </SC.List>
          </SC.Wrap>
